...
export const dawThemeTokenNames: readonly DawThemeTokenName[] = [
  "background",
  "foreground",
  "card",
  "card-foreground",
...
export type DawThemeTokenOverrides = Partial<Record<DawThemeTokenName, string>>
