...
export default function Phaser(props: PhaserProps) {
  ...
  return <EffectShell title="Phaser" typeLabel="Modulation" enabled={props.params.enabled} onToggleEnabled={props.onToggleEnabled} onReset={props.onReset} class="w-[500px] min-w-[500px]"><div class="flex flex-1 gap-3 px-3 py-2">
    <div class="grid grid-cols-6 gap-2">
      ...
      {knob('Rate', 'phaser.rateHz', props.params.rateHz, defaults.rateHz, 0.01, 20, 0.01, `${props.params.rateHz.toFixed(2)} Hz`, (rateHz) => ({ rateHz }))}
    ...
    <div class="grid w-16 grid-cols-2 gap-1 content-start">
