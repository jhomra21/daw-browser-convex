...
export const nativeAudioHostMaximumPayloadBytes = 16 * 1024 * 1024
...
export const nativeAudioHostMaximumAssetFrames = 1_048_576
...
export const nativeAudioHostMaximumProcessorEvents = 256
