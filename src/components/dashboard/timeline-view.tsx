        ...
        {(model) => (
          <DashboardSection title="Timeline / DAW" description="Project-scoped timeline preferences.">
            <DashboardRow
              ...
              action={
                <input
                  class="w-20 border border-border bg-app-surface px-2 py-1 text-xs text-foreground"
                  type="number"
                  min="30"
                  max="300"
                  value={model.bpm()}
            ...
            <DashboardRow
              ...
              action={
                <select
                  class="border border-border bg-app-surface px-2 py-1 text-xs text-foreground"
