...
{"version":3,"artifactKind":"production","abiVersion":3,"pagedAbi":1,"contractVersion":1,"contractHash":"$contract_hash","buildType":"Release","lto":true,"fixedMemory":true,"memoryBytes":268435456,"sizeBytes":$artifact_size,"maximumBytes":$maximum_bytes,"sha256":"$artifact_hash","sourceHash":"$source_hash","wasmUrl":"/audio-core/daw-audio-core.wasm"}
EOF
