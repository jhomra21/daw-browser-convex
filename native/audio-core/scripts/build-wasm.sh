...
{"version":2,"artifactKind":"production","abiVersion":2,"contractVersion":1,"contractHash":"$contract_hash","buildType":"Release","lto":true,"fixedMemory":true,"memoryBytes":184549376,"sizeBytes":$artifact_size,"maximumBytes":$maximum_bytes,"sha256":"$artifact_hash","wasmUrl":"/audio-core/daw-audio-core.wasm"}
EOF
