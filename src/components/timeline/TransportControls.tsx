        ...
        <DropdownMenu open={samplesOpen()} onOpenChange={setSamplesOpen}>
          ...
          <DropdownMenuContent class="w-full bg-neutral-900" style={{ width: 'min(92vw, 26rem)', 'pointer-events': isDraggingSample() ? 'none' : undefined }}>
            <div class="p-2 w-full">
              ...
              <div class="max-h-72 overflow-y-auto">
                <Show
                  when={(samplesList().length + defaultSamplesList().length) > 0}
                  fallback={<div class="px-2 py-2 text-xs text-neutral-500">No samples yet</div>}
                >
                          ...
                          >
                            ...
                            <div class="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1">
                              ...
                              <button
                                ...
                                onClick={async (ev) => {
                                  ev.stopPropagation(); ev.preventDefault()
                                  await handleInsertSampleAction(sample)
                                }}
                              >
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-4 w-4">
